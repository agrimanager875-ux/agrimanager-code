...
RUN_NAME="cycles_gym_price_regime_llm_no_think_train"
DATASET_CONFIG="$SCRIPT_DIR/config/price_regime_llm_no_think.yaml"
DATASET_ID="cycles_gym_price_regime_llm_no_think"
