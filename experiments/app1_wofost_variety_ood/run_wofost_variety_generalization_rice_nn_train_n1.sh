...
RUN_NAME="wofost_variety_generalization_rice_nn_train_16ep_n1"
DATASET_CONFIG="$SCRIPT_DIR/config/rice_variety_nn_traits_v1.yaml"
...
bash entrypoints/train/nn_train.sh \
    ...
    "agent.track=true" \
    "agent.wandb_project_name=agrimanager_wofost_variety_generalization" \
    "agent.num_envs=32" \
    "agent.num_steps=72" \
