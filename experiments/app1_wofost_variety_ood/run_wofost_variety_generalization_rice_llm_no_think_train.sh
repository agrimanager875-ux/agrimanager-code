...
RUN_NAME="wofost_variety_generalization_rice_llm_no_think_train"
DATASET_CONFIG="$SCRIPT_DIR/config/rice_variety_llm_traits_v1_no_think.yaml"
...
exec bash entrypoints/train/train.sh \
    ...
    "trainer.project_name=agrimanager_wofost_variety_generalization" \
