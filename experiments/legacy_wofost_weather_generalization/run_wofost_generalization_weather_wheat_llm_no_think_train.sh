...
RUN_NAME="wofost_generalization_weather_wheat_llm_no_think_train"
DATASET_CONFIG="$SCRIPT_DIR/config/weather_wheat_llm_without_traits_no_think.yaml"
...
exec bash entrypoints/train/train.sh \
    ...
    "trainer.project_name=agrimanager_wofost_weather_generalization" \
