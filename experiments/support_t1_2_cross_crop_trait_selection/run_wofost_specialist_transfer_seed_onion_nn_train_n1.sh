...
RUN_NAME="wofost_specialist_transfer_seed_onion_nn_train_16ep_n1"
DATASET_CONFIG="$SCRIPT_DIR/config/specialist_transfer_seed_onion_nn_without_traits.yaml"
...
bash entrypoints/train/nn_train.sh \
    ...
    "runtime.validation.evals_per_epoch=1" \
